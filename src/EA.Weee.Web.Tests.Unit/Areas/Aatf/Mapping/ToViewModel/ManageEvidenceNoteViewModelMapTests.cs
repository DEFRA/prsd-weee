namespace EA.Weee.Web.Tests.Unit.Areas.Aatf.Mapping.ToViewModel
{
    ...
    public class ManageEvidenceNoteViewModelMapTests
    {
        ...
        public void Map_GivenSourceWithSingleAatf_MapperShouldBeCalled()
        {
            ...
            var source = new ManageEvidenceNoteTransfer(organisationId, aatfId, aatfData, aatfDataList, null, null, null);
        ...
        public void Map_GivenSourceWithValidFilterModel_MapperShouldBeCalled()
        {
            ...
            var source = new ManageEvidenceNoteTransfer(organisationId, aatfId, aatfData, aatfDataList, filterModel, null, null);
        ...
        public void Map_GivenSourceWithValidRecipientWasteStatusModel_MapperShouldBeCalled()
        {
            ...
            var source = new ManageEvidenceNoteTransfer(organisationId, aatfId, aatfData, aatfDataList, null, recipientWasteStatusModel, null);
        ...
        public void Map_GivenSourceWithValidModel_MapperShouldBeCalled()
        {
            ...
            var source = new ManageEvidenceNoteTransfer(organisationId, aatfId, aatfData, aatfDataList, null, null, submittedDateModel);
