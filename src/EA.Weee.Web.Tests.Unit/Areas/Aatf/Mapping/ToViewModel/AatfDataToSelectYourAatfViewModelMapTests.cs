namespace EA.Weee.Web.Tests.Unit.Areas.Aatf.Mapping.ToViewModel
{
    ...
    public class AatfDataToSelectYourAatfViewModelMapTests
    {
        ...
        public void Map_GivenAatfsAndAatfFacilityType_AatfListShouldOnlyContainAatfs()
        {
            ...
            var transfer = new AatfDataToSelectYourAatfViewModelMapTransfer() { OrganisationId = fixture.Create<Guid>(), AatfList = aatfList, FacilityType = FacilityType.Aatf };
        ...
        public void Map_GivenAesAndAeFacilityType_AatfListShouldOnlyContainAes()
        {
            ...
            var transfer = new AatfDataToSelectYourAatfViewModelMapTransfer() { OrganisationId = fixture.Create<Guid>(), AatfList = aatfList, FacilityType = FacilityType.Ae };
