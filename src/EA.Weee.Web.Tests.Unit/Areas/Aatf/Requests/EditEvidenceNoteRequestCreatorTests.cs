namespace EA.Weee.Web.Tests.Unit.Areas.Aatf.Requests
{
    ...
    public class EditEvidenceNoteRequestCreatorTests
    {
        ...
        [Fact]
        public void ViewModelToRequest_GivenSaveAndViewModelStatusIsNotSet_EditEvidenceNoteRequestShouldBeCreatedWithDraftStatus()
        {
            //arrange
            var id = fixture.Create<Guid>();
            var model = ValidModel();
        ...
        [Fact]
        public void ViewModelToRequest_GivenSaveAndViewModelStatusIsSet_EditEvidenceNoteRequestShouldBeCreatedWithCorrectStatus()
        {
            //arrange
            var id = fixture.Create<Guid>();
            var model = ValidModel();
