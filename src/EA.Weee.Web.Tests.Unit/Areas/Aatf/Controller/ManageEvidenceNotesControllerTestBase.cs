namespace EA.Weee.Web.Tests.Unit.Areas.Aatf.Controller
{
    ...
    public class ManageEvidenceNotesControllerTestsBase
    {
        ...
        public ManageEvidenceNotesControllerTestsBase()
        {
            ...
            ManageEvidenceController = new ManageEvidenceNotesController(Mapper, Breadcrumb, Cache, () => WeeeClient, CreateRequestCreator, EditRequestCreator, SessionService, ConfigurationService);
        }
