namespace EA.Weee.Web.Tests.Unit.Areas.AatfReturn.ViewModels
{
    ...
    public class AatfTaskListViewModelTests
    {
        [Fact]
        public void AatfTaskListViewModel_GivenQuarterIsNull_ArgumentNullExceptionExpected()
        {
            Action action = () =>
            {
        ...
        [Fact]
        public void AatfTaskListViewModel_GivenQuarterWindowIsNull_ArgumentNullExceptionExpected()
        {
            Action action = () =>
            {
