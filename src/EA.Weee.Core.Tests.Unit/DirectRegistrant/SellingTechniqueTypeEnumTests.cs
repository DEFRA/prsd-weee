namespace EA.Weee.Core.Tests.Unit.DirectRegistrant
{
    ...
    public class SellingTechniqueTypeEnumTests
    {
        ...
        public void SellingTechniqueType_ShouldHaveValues()
        {
            ...
            values.Should().Contain(c => c.Key.Equals(0) && c.Value.Equals("Direct Selling to End User"));
            values.Should().Contain(c => c.Key.Equals(1) && c.Value.Equals("Indirect Selling to End User"));
