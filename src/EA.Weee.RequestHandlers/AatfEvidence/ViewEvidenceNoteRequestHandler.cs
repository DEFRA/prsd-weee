namespace EA.Weee.RequestHandlers.AatfEvidence
{
    ...
    public class ViewEvidenceNoteRequestHandler : IViewEvidenceNoteRequestHandler<int, ViewEvidenceNoteViewModel>
    {
        ...
        public ViewEvidenceNoteRequestHandler(IWeeeAuthorization authorization,
        ...
        public async Task<int> HandleAsync(GetViewEvidenceNoteRequest message)
        {
