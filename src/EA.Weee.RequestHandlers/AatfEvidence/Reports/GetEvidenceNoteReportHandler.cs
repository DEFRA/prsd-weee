namespace EA.Weee.RequestHandlers.AatfEvidence.Reports
{
    ...
    internal class GetEvidenceNoteReportHandler : IRequestHandler<GetEvidenceNoteReportRequest, CSVFileData>
    {
        ...
        public async Task<CSVFileData> HandleAsync(GetEvidenceNoteReportRequest request)
        {
            ...
            //Note: I am not sure what I am doing here -- this handler is likely to be shared 
            //      so perhaps we need a means to tell an AATF to conditionally remove the 5 lines below
            //      documentation is ambiguous so I am not even certain these are the columns to remove
