namespace EA.Weee.RequestHandlers.Scheme.MemberRegistration
{
    ...
    public interface ITotalChargeCalculatorDataAccess
    {
        ...
        bool CheckForIsSubmittedHasAnnualChargeFlagSet(ProcessXmlFile message, Scheme scheme, int deserializedcomplianceYear, List<MemberUpload> memberUploadsCheckAgainstNotSubmitted);
