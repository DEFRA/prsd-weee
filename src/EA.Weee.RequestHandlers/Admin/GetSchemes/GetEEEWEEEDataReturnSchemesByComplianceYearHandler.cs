namespace EA.Weee.RequestHandlers.Admin.GetSchemes
{
    ...
    public class GetEEEWEEEDataReturnSchemesByComplianceYearHandler : IRequestHandler<GetEEEWEEEDataReturnSchemesByComplianceYear, List<SchemeData>>
    {
        ...
        public GetEEEWEEEDataReturnSchemesByComplianceYearHandler(IWeeeAuthorization authorization, IMap<Scheme, SchemeData> schemeMap, WeeeContext context, ISchemeDataAccess schemeDataAccess)
        {
