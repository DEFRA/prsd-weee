GO
PRINT N'Altering [Lookup].[QuarterWindow]...';

DECLARE @tblTempQuarterWindow TABLE  (
...
INSERT INTO @tblTempQuarterWindow (Id, Quarter, AddStartYears, StartMonth, StartDay, AddEndYears, EndMonth, EndDay)
...
INSERT INTO [Lookup].[QuarterWindow] (Id , Quarter, AddStartYears, StartMonth, StartDay, AddEndYears, EndMonth, EndDay) 
SELECT tmp.[Id], tmp.[Quarter], tmp.[AddStartYears], tmp.[StartMonth], tmp.[StartDay], tmp.[AddEndYears], tmp.[EndMonth], tmp.[EndDay]
FROM @tblTempQuarterWindow tmp
LEFT JOIN [Lookup].[QuarterWindow] tbl ON tbl.[Id] = tmp.[Id]
