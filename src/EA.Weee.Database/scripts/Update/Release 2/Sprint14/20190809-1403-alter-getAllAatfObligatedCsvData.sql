IF OBJECT_ID('[AATF].getAllAatfObligatedCsvData', 'P') IS NOT NULL BEGIN
	DROP PROCEDURE [AATF].[getAllAatfObligatedCsvData]
END
GO
/****** Object:  StoredProcedure [AATF].[getAllAatfObligatedCsvData]    Script Date: 08/08/2019 12:58:53 ******/
SET ANSI_NULLS ON
GO
