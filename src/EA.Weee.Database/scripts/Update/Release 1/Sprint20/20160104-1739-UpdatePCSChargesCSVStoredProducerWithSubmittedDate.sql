/*
 * This script updates the [Producer].[spgPCSChargesCSVDataByComplianceYearAndAuthorisedAuthority] stored procedure
 * to use the new [SubmittedDate] column of the [PCS].[MemberUpload] table.
 */
...
BEGIN
	...
	SELECT
		...
		MU.[SubmittedDate] AS 'SubmissionDate',
