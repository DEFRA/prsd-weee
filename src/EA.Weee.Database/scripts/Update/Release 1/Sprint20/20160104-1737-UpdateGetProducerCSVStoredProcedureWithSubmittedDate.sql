/*
 * This script updates the [Producer].[spgCSVDataBySchemeComplianceYearAndAuthorisedAuthority] stored procedure
 * to use the new [SubmittedDate] column of the [PCS].[MemberUpload] table to calculate the
 * 'DateRegistered' and 'DateAmended values for each registered producer.
 */
