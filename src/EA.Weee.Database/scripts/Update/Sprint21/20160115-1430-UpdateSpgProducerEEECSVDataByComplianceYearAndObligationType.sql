GO
/****** Object:  StoredProcedure [Producer].[spgProducerEEECSVDataByComplianceYearAndObligationType]    Script Date: 15/01/2016 13:48:05 ******/
SET ANSI_NULLS ON
GO
...
--				for Producer.
-- =============================================
ALTER PROCEDURE [Producer].[spgProducerEEECSVDataByComplianceYearAndObligationType]
	@ComplianceYear INT,
