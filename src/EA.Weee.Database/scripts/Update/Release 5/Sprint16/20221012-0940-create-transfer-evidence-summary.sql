...
SELECT
		...
		approvedHistory.ChangedDate AS ApprovedDateTime,
		...
		CASE WHEN n.ApprovedTransfererSchemeName IS NOT NULL THEN n.ApprovedRecipientSchemeName ELSE recipientScheme.SchemeName END AS RecipientSchemeName,
