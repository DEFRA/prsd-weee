...
SELECT
		...
		CASE WHEN n.ApprovedRecipientSchemeApprovalNumber IS NOT NULL THEN n.ApprovedRecipientSchemeApprovalNumber ELSE s.ApprovalNumber END AS RecipientApprovalNumber,
		ep.[Name] AS Protocol,
