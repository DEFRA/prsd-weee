...
--SEPA
IF EXISTS (SELECT 1 FROM [Lookup].[CompetentAuthority] WHERE Id = @SEPAId)
	BEGIN
...
--NIEA
IF EXISTS (SELECT 1 FROM [Lookup].[CompetentAuthority] WHERE Id = @NIEAId)
	BEGIN
...
--NRW
IF EXISTS (SELECT 1 FROM [Lookup].[CompetentAuthority] WHERE Id = @NRWId)
	BEGIN
