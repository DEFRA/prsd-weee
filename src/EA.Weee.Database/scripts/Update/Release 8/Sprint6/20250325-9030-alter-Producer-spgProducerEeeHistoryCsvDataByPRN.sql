/****** Object:  StoredProcedure [Producer].[spgProducerEeeHistoryCsvDataByPRN]    Script Date: 25/03/2025 20:38:37 ******/
SET ANSI_NULLS ON
GO
...
DECLARE @ProducerEEEHistoryReturns TABLE
	(	
		...
		[Cat13B2C] decimal(28,3) NULL,	[Cat14B2C] decimal(28,3) NULL,	[Cat15B2C] decimal(28,3) NULL,
		...
		[Cat13B2B] decimal(28,3) NULL,	[Cat14B2B] decimal(28,3) NULL,	[Cat15B2B] decimal(28,3) NULL	
	)
...
WHERE
    ...
    (
	    ...
	    (
            ...
            [10] AS Cat10, [11] AS Cat11, [12] AS Cat12, [13] AS Cat13, [14] AS Cat14, [15] AS Cat15
...
SELECT DISTINCT Producers.PRN,  
		...
		Producers.ApprovalNumber, Producers.SchemeName, Producers.ComplianceYear, 		
                        ...
                        B2C.Cat10B2C,B2C.Cat11B2C, B2C.Cat12B2C, B2C.Cat13B2C,B2C.Cat14B2C, B2C.Cat15B2C, 
                        B2B.Cat1B2B,B2B.Cat2B2B,B2B.Cat3B2B, B2B.Cat4B2B, B2B.Cat5B2B, B2B.Cat6B2B, B2B.Cat7B2B, B2B.Cat8B2B,B2B.Cat9B2B,
						B2B.Cat10B2B,B2B.Cat11B2B, B2B.Cat12B2B, B2B.Cat13B2B,B2B.Cat14B2B,B2B.Cat15B2B
        FROM (
