-- =====================================================================
-- Script to create AnnualChargeByYear lookup table for year-specific
-- annual subsistence fees by Competent Authority
-- 
...
PRINT N'';
PRINT N'Summary:';
PRINT N'  - Table: [Lookup].[AnnualChargeByYear]';
