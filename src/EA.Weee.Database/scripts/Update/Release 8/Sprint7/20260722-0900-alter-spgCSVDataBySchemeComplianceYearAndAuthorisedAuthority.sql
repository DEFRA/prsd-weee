/****** Object:  StoredProcedure [Producer].[spgCSVDataBySchemeComplianceYearAndAuthorisedAuthority]    Script Date: 22/07/2026 14:00:00 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================================================================================
-- Modified Date: 22/07/2026 09:00:00 
...
BEGIN
	...
	SELECT
		...
		loc.[Name] as 'PrimaryContactCountry',
		...
		-- Producer Information
		-- Fixed: 22-07-2026 Use year-specific submission history instead of root organisation
		...
		CASE 
			...
			WHEN oa.WebAddress IS NOT NULL THEN oa.WebAddress
			ELSE
				''
