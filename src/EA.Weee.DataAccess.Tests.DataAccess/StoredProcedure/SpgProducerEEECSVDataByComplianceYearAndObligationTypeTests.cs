    ...
    public class SpgProducerEEECSVDataByComplianceYearAndObligationTypeTests
    {
        ...
        public async Task Execute_ReturnsEeeData_ForNonRemovedProducersOnly()
        {
            using (DatabaseWrapper db = new DatabaseWrapper())
            {
                ...
                var dataReturnVersion = helper.CreateDataReturnVersion(scheme, 2016, 1);
                ...
                // Act
                var results =
                    await db.StoredProcedures.SpgProducerEEECSVDataByComplianceYearAndObligationType(2016, "B2C");
