    ...
    public class GetAatfEvidenceSummaryTotalsTests
    {
        ...
        public async Task Execute_GivenAatfWithData_DataShouldBeReturned()
        {
            using (var db = new DatabaseWrapper())
            {
                ...
                totals.ElementAt(0).CategoryName.Should().Be(WeeeCategory.LargeHouseholdAppliances.ToDisplayString());
                ...
                totals.ElementAt(1).CategoryName.Should().Be(WeeeCategory.SmallHouseholdAppliances.ToDisplayString());
                ...
                totals.ElementAt(2).CategoryName.Should().Be(WeeeCategory.ITAndTelecommsEquipment.ToDisplayString());
                ...
                totals.ElementAt(3).CategoryName.Should().Be(WeeeCategory.ConsumerEquipment.ToDisplayString());
                ...
                totals.ElementAt(4).CategoryName.Should().Be(WeeeCategory.LightingEquipment.ToDisplayString());
                ...
                totals.ElementAt(5).CategoryName.Should().Be(WeeeCategory.ElectricalAndElectronicTools.ToDisplayString());
                ...
                totals.ElementAt(6).CategoryName.Should().Be(WeeeCategory.ToysLeisureAndSports.ToDisplayString());
                ...
                totals.ElementAt(7).CategoryName.Should().Be(WeeeCategory.MedicalDevices.ToDisplayString());
                ...
                totals.ElementAt(8).CategoryName.Should().Be(WeeeCategory.MonitoringAndControlInstruments.ToDisplayString());
                ...
                totals.ElementAt(9).CategoryName.Should().Be(WeeeCategory.AutomaticDispensers.ToDisplayString());
                ...
                totals.ElementAt(10).CategoryName.Should().Be(WeeeCategory.DisplayEquipment.ToDisplayString());
                ...
                totals.ElementAt(11).CategoryName.Should().Be(WeeeCategory.CoolingApplicancesContainingRefrigerants.ToDisplayString());
                ...
                totals.ElementAt(12).CategoryName.Should().Be(WeeeCategory.GasDischargeLampsAndLedLightSources.ToDisplayString());
                ...
                totals.ElementAt(13).CategoryName.Should().Be(WeeeCategory.PhotovoltaicPanels.ToDisplayString());
