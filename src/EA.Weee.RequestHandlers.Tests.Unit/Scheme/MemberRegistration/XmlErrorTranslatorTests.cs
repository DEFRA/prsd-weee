namespace EA.Weee.RequestHandlers.Tests.Unit.Scheme.MemberRegistration
{
    ...
    public class XmlErrorTranslatorTests
    {
        ...
        public void XmlErrorTranslator_InvalidChildElement_CorrectMessage()
        {
            ...
            string expectedFriendlyMessage = AddUniversalMessageParts(string.Format("The field {0} isn't expected here.", TestField));
        ...
        public void XmlErrorTranslator_ErrorInXmlDocument_CorrectMessage()
        {
            ...
            string expectedFriendlyMessage = string.Format("{0} This can be caused by an error on this line, or before it. (XML file line {1})", providedException, lineNumber);
        ...
        private string AddUniversalMessageParts(string specificMessage)
        {
            ...
            var lineNumberText = string.Format("(XML file line {0})", TestLineNumber);
