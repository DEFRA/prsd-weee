namespace EA.Weee.RequestHandlers.Tests.Unit.Scheme.MemberUploadTesting
{
    ...
    //        Domain.Producer.ProducerSubmission producer1 = A.Fake<Domain.Producer.ProducerSubmission>();
    ...
    //        Domain.Producer.ProducerSubmission producer2 = A.Fake<Domain.Producer.ProducerSubmission>();
    ...
    //        Domain.Producer.ProducerSubmission producer3 = A.Fake<Domain.Producer.ProducerSubmission>();
    ...
    //        Domain.Producer.ProducerSubmission producer4 = A.Fake<Domain.Producer.ProducerSubmission>();
    ...
    //        Domain.Producer.ProducerSubmission producer5 = A.Fake<Domain.Producer.ProducerSubmission>();
    ...
    //        Domain.Producer.ProducerSubmission producer6 = A.Fake<Domain.Producer.ProducerSubmission>();
    ...
    //        Domain.Producer.ProducerSubmission producer7 = A.Fake<Domain.Producer.ProducerSubmission>();
    ...
    //        Domain.Producer.ProducerSubmission producer8 = A.Fake<Domain.Producer.ProducerSubmission>();
    ...
    //        Domain.Producer.ProducerSubmission producer9 = A.Fake<Domain.Producer.ProducerSubmission>();
    ...
    //        Domain.Producer.ProducerSubmission producer10 = A.Fake<Domain.Producer.ProducerSubmission>();
    ...
    //        A.CallTo(() => scheme1.Producers).Returns(new List<Domain.Producer.ProducerSubmission>()
    //        {
    //            producer1,
    //            producer2,
    //            producer3,
    ...
    //        A.CallTo(() => scheme2.Producers).Returns(new List<Domain.Producer.ProducerSubmission>()
    //        {
    //            producer6,
    //            producer7,
    //            producer8,
    ...
    //        A.CallTo(() => memberUploadSubmitted.ProducerSubmissions).Returns(new List<Domain.Producer.ProducerSubmission>()
    //            {
    //                producer1,
    //                producer2,
    //                producer3,
    ...
    //                producer9,
    //            });
    //        A.CallTo(() => memberUploadUnsubmitted.ProducerSubmissions).Returns(new List<Domain.Producer.ProducerSubmission>()
    //            {
    //                producer5,
    //                producer10,
    //            });
    ...
    //        var producersDbSet = dbContextHelper.GetAsyncEnabledDbSet(new List<Domain.Producer.ProducerSubmission>()
    //            {
    //                producer1,
    //                producer2,
    //                producer3,
    ...
    //                producer10,
    //            });
    //        A.CallTo(() => weeeContext.ProducerSubmissions).Returns(producersDbSet);
