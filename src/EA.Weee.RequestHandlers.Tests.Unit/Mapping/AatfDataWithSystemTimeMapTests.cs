namespace EA.Weee.RequestHandlers.Tests.Unit.Mapping
{
    ...
    public class AatfDataWithSystemTimeMapTests : SimpleUnitTestBase
    {
        ...
        [Fact]
        public void Map_GivenMappedAatfDataHasEvidenceNotes_EvidenceSiteDisplayShouldBeTrue()
        {
            //arrange
            var aatfData = TestFixture.Build<AatfData>().With(a => a.HasEvidenceNotes, true).Create();
            A.CallTo(() => aatfMap.Map(A<Aatf>._)).Returns(aatfData);
