namespace EA.Weee.RequestHandlers.Tests.Unit.Mapping
{
    ...
    public class AatfDataListMapTests
    {
        ...
        public void Map_GivenSource_AatfDataListPropertiesShouldBeMapped()
        {
            ...
            var source = new Aatf(name, competentAuthority, approvalNumber, status, @operator, A.Fake<AatfAddress>(), A.Fake<Domain.AatfReturn.AatfSize>(), DateTime.Now, A.Fake<AatfContact>(), FacilityType.Aatf);
