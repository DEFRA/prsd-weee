namespace EA.Weee.RequestHandlers.Tests.Unit.Mapping
{
    ...
    public class AatfMapTests
    {
        ...
        public AatfMapTests()
        {
            map = new AatfMap(A.Fake<UKCompetentAuthorityMap>(), A.Fake<AatfStatusMap>(), A.Fake<AatfSizeMap>(), A.Fake<AatfAddressMap>(), A.Fake<AatfContactMap>(), A.Fake<OrganisationMap>(), A.Fake<FacilityTypeMap>());
        }
