namespace EA.Weee.RequestHandlers.Tests.Unit.Admin.Aatf
{
    ...
    public class GetAatfInfoByAatfIdRequestHandlerTests
    {
        ...
        public async Task HandleAsync_GivenReturn_MappedObjectShouldBeReturned()
        {
            ...
            Aatf aatf = new Aatf("name", A.Dummy<UKCompetentAuthority>(), "1234", Domain.AatfReturn.AatfStatus.Approved, A.Fake<Operator>(), A.Dummy<AatfAddress>(), Domain.AatfReturn.AatfSize.Large, date, A.Fake<AatfContact>(), FacilityType.Aatf);
