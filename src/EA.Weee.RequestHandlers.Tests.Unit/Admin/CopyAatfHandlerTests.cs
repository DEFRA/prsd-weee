namespace EA.Weee.RequestHandlers.Tests.Unit.Admin
{
    ...
    public class CopyAatfHandlerTests
    {
        ...
        private readonly CopyAatfHandler handler;

        public CopyAatfHandlerTests()
        {
            ...
            handler = new CopyAatfHandler(AuthorizationBuilder.CreateUserWithAllRights(), dataAccess, addressMapper, contactMapper, commonDataAccess);
        }
        ...
        public async Task HandleAsync_WithNonInternalAccess_ThrowsSecurityException(AuthorizationBuilder.UserType userType)
        {
            ...
            var handler = new CopyAatfHandler(authorization, dataAccess, addressMapper, contactMapper, commonDataAccess);

            Func<Task> action = async () => await handler.HandleAsync(A.Dummy<CopyAatf>());
        ...
        public async Task HandleAsync_WithNonInternalAdminRole_ThrowsSecurityException()
        {
            ...
            var handler = new CopyAatfHandler(authorization, this.dataAccess, addressMapper, contactMapper, commonDataAccess);
