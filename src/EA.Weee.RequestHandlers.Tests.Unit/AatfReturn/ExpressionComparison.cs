namespace EA.Weee.RequestHandlers.Tests.Unit.AatfReturn
{
    ...
    public class ExpressionEqualityComparer : IEqualityComparer<Expression>
    {
        ...
        private bool AreAllArgumentsEqual<T>(IEnumerable<T> enumerables, IEnumerable<T> enumerables2)
            where T : Expression
        {
            var argumentEnumeratorX = enumerables.GetEnumerator();
            var argumentEnumeratorY = enumerables2.GetEnumerator();
