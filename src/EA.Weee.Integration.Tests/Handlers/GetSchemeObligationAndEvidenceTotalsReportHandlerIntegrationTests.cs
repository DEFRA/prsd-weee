...
");
        ...
        [Component]
        public class WhenIGetASchemesObligationAndEvidenceTotalsByOrganisationAndComplianceYear : GetSchemeObligationAndEvidenceTotalsReportHandlerIntegrationTestBase
        {
            private static Scheme scheme;
            private readonly Establish context = () =>
            {
...
");
        ...
        [Component]
        public class WhenIGetAnOrganisationObligationAndEvidenceTotalsByOrganisationAndComplianceYear : GetSchemeObligationAndEvidenceTotalsReportHandlerIntegrationTestBase
        {
            private static Scheme scheme;
            private readonly Establish context = () =>
            {
                ...
                var anotherRecipientOrganisation = OrganisationDbSetup.Init().Create();
                SchemeDbSetup.Init().WithOrganisation(anotherRecipientOrganisation.Id).WithAuthority(anotherRecipientOrganisation.Id).Create();
                EvidenceNoteDbSetup.Init().WithOrganisation(recipientOrganisation.Id)
                    .WithRecipient(anotherRecipientOrganisation.Id)
                    .WithTonnages(recipientAsOriginatorTonnages)
                    .WithWasteType(WasteType.HouseHold)
