        ...
        public class WhenIGetTheTransferNoteReportWithComplianceYear : GetTransferNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            private readonly Establish context = () =>
            {
                ...
                var newTransferTonnages1 = new List<NoteTransferTonnage>()
                {
                    ...
                    new NoteTransferTonnage(note2.NoteTonnage.First(nt => nt.CategoryId.Equals(WeeeCategory.MonitoringAndControlInstruments)).Id, 1, null)
                };
                ...
                {
                    new NoteTransferTonnage(note2.NoteTonnage.First(nt => nt.CategoryId.Equals(WeeeCategory.LargeHouseholdAppliances)).Id, 2, null)
                };
                ...
                {
                    new NoteTransferTonnage(note2.NoteTonnage.First(nt => nt.CategoryId.Equals(WeeeCategory.SmallHouseholdAppliances)).Id, 10, 1)
                };
