namespace EA.Weee.Integration.Tests.Handlers
{
    ...
    {
        [Component]
        public class WhenIGetTheEvidenceNoteReportAsInternalReportAndOriginalTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            ...
            private readonly It shouldHaveReturnedExpectedCsv = () =>
            {
                ...
                var expectedCsvData =
                    ...
                    $"E3,Approved,SEPA,{note3SubmittedDate},{note3.Aatf.Name},{note3.Aatf.ApprovalNumber},Household,{note3.StartDate.ToShortDateString()},{note3.EndDate.ToShortDateString()},{note3.Recipient.Name},,Reuse network PWP,22.444,20.222,24.666,9.999,26.888,7.777,11.222,2.333,28.111,13.444,15.666,18.999,5.555,1.111,2.222,210.659,23.555,21.333,25.777,10.111,27.999,8.888,12.333,4.444,29.222,14.555,17.777,19.111,6.666,2.222,3.001,226.994\r\n" +

                    $"E4,Approved,SEPA,{note4SubmittedDate},{note4.Aatf.Name},{note4.Aatf.ApprovalNumber},Household,{note4.StartDate.ToShortDateString()},{note4.EndDate.ToShortDateString()},{approvedSchemeName},{note4.Recipient.Scheme.ApprovalNumber},Reuse network PWP,22.444,20.222,24.666,9.999,26.888,7.777,11.222,2.333,28.111,13.444,15.666,18.999,5.555,1.111,2.222,210.659,23.555,21.333,25.777,10.111,27.999,8.888,12.333,4.444,29.222,14.555,17.777,19.111,6.666,2.222,3.001,226.994\r\n";
        ...
        public class WhenIGetTheEvidenceNoteReportWithAatfParameterAndOriginalTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            private readonly Establish context = () =>
            {
                ...
                request = new GetEvidenceNoteReportRequest(null, aatf1.Id, TonnageToDisplayReportEnum.OriginalTonnages, SystemTime.Now.Year);
            };
            ...
            private readonly It shouldHaveReturnedExpectedCsv = () =>
            {
                ...
                var expectedCsvData =
                    ...
                    $"E3,Approved,{note3SubmittedDate},Household,{note3.StartDate.ToShortDateString()},{note3.EndDate.ToShortDateString()},{note3.Recipient.OrganisationName},,Reuse network PWP,22.444,20.222,24.666,9.999,26.888,7.777,11.222,2.333,28.111,13.444,15.666,18.999,5.555,1.111,2.222,210.659,23.555,21.333,25.777,10.111,27.999,8.888,12.333,4.444,29.222,14.555,17.777,19.111,6.666,2.222,3.001,226.994\r\n";
        ...
        [Component]
        public class WhenIGetTheEvidenceNoteReportAsInternalReportAndNetTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            private readonly Establish context = () =>
            {
                LocalInternalSetup();
            ...
            private readonly It shouldHaveReturnedExpectedCsv = () =>
            {
                ...
                var expectedCsvData =
                    ...
                    $"E4,Approved,SEPA,{note4SubmittedDate},{note4.Aatf.Name},{note4.Aatf.ApprovalNumber},Household,{note4.StartDate.ToShortDateString()},{note4.EndDate.ToShortDateString()},{note4.Recipient.Name},,Reuse network PWP,10.244,9.322,10.266,9.099,10.288,7.077,9.122,2.033,9.311,9.144,9.166,10.299,5.055,1.011,2.022,113.459,10.255,10.233,10.277,9.011,10.299,8.088,9.133,4.044,9.322,9.155,10.177,9.311,6.066,2.022,3.003,120.396\r\n" +

                    $"E8,Approved,SEPA,{note5SubmittedDate},{note5.Aatf.Name},{note5.Aatf.ApprovalNumber},Household,{note5.StartDate.ToShortDateString()},{note5.EndDate.ToShortDateString()},{approvedSchemeName},{note5.Recipient.Scheme.ApprovalNumber},Reuse network PWP,22.444,20.222,24.666,9.999,26.888,7.777,11.222,2.333,28.111,13.444,15.666,18.999,5.555,1.111,2.222,210.659,23.555,21.333,25.777,10.111,27.999,8.888,12.333,4.444,29.222,14.555,17.777,19.111,6.666,2.222,3.001,226.994\r\n";
        ...
        public class WhenIGetTheEvidenceNoteReportWithRecipientOrganisationAndOriginalTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            private readonly Establish context = () =>
            {
                ...
                var approvedNoteWithSchemeNameUpdateTonnages = new List<NoteTonnage>()
                {
                    ...
                    new NoteTonnage(WeeeCategory.LightingEquipment, 26.888M, 27.999M),
                    new NoteTonnage(WeeeCategory.MonitoringAndControlInstruments, 28.111M, 29.222M),
                    new NoteTonnage(WeeeCategory.MonitoringAndControlInstruments, 29.111M, 30.222M),
                };
            ...
            private readonly It shouldHaveReturnedExpectedCsv = () =>
            {
                ...
                var expectedCsvData =
                    ...
                    $"E2,Submitted,{note2SubmittedDate},{note2.Aatf.Name},{note2.Aatf.ApprovalNumber},Household,{note2.StartDate.ToShortDateString()},{note2.EndDate.ToShortDateString()},Actual,22.444,20.222,24.666,9.999,26.888,7.777,11.222,2.333,28.111,13.444,15.666,18.999,5.555,1.111,2.222,210.659,23.555,21.333,25.777,10.111,27.999,8.888,12.333,4.444,29.222,14.555,17.777,19.111,6.666,2.222,3.001,226.994\r\n" +
                    ...
                    $"E6,Approved,{note4SubmittedDate},{note4.Aatf.Name},{note4.Aatf.ApprovalNumber},Household,{note4.StartDate.ToShortDateString()},{note4.EndDate.ToShortDateString()},Reuse network PWP,22.444,20.222,24.666,9.999,26.888,7.777,11.222,2.333,28.111,13.444,15.666,18.999,5.555,1.111,2.222,210.659,23.555,21.333,25.777,10.111,27.999,8.888,12.333,4.444,29.222,14.555,17.777,19.111,6.666,2.222,3.001,226.994\r\n";
        ...
        public class WhenIGetTheEvidenceNoteReportWithRecipientOrganisationAndNetTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            private readonly Establish context = () =>
            {
                ...
                request = new GetEvidenceNoteReportRequest(recipientOrganisation1.Id, null, TonnageToDisplayReportEnum.Net, SystemTime.Now.Year);
            };
            ...
            private readonly It shouldHaveReturnedExpectedCsv = () =>
            {
                ...
                var expectedCsvData =
                    ...
                    $"E4,Approved,{note2SubmittedDate},{note2.Aatf.Name},{note2.Aatf.ApprovalNumber},Household,{note2.StartDate.ToShortDateString()},{note2.EndDate.ToShortDateString()},Reuse network PWP,10.244,9.322,10.266,9.099,10.288,7.077,9.122,2.033,9.311,9.144,9.166,10.299,5.055,1.011,1.011,112.448,10.255,10.233,10.277,9.011,10.299,8.088,9.133,4.044,9.322,9.155,10.177,9.311,6.066,2.022,1.001,118.394\r\n" +

                    $"E10,Returned,{note3SubmittedDate},{note3.Aatf.Name},{note3.Aatf.ApprovalNumber},Non-household,{note3.StartDate.ToShortDateString()},{note3.EndDate.ToShortDateString()},Site specific protocol,21.000,19.000,23.000,9.000,25.000,7.000,11.000,3.000,27.000,13.000,15.000,17.000,5.000,1.000,1.000,197.000,22.000,20.000,24.000,10.000,26.000,8.000,12.000,4.000,28.000,14.000,16.000,18.000,6.000,2.000,3.000,213.000\r\n" +

                    $"E11,Approved,{note4SubmittedDate},{note4.Aatf.Name},{note4.Aatf.ApprovalNumber},Household,{note4.StartDate.ToShortDateString()},{note4.EndDate.ToShortDateString()},Reuse network PWP,22.444,20.222,24.666,9.999,26.888,7.777,11.222,2.333,28.111,13.444,15.666,18.999,5.555,1.111,1.111,209.548,23.555,21.333,25.777,10.111,27.999,8.888,12.333,4.444,29.222,14.555,17.777,19.111,6.666,2.222,3.001,226.994\r\n";
        ...
        public class WhenIGetTheEvidenceNoteReportWithAatfParameterAndNetTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            private readonly Establish context = () =>
            {
                ...
                request = new GetEvidenceNoteReportRequest(null, aatf1.Id, TonnageToDisplayReportEnum.Net, SystemTime.Now.Year);
            };
