        ...
        public class WhenIGetTheEvidenceNoteReportWithOrganisationParameterAndNetTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            ...
            private readonly It shouldHaveReturnedExpectedCsv = () =>
            {
                ...
                var expectedCsvData =
                    ...
                    $"E3,Approved,EA,{note2SubmittedDate},{note2.Aatf.Name},{note2.Aatf.ApprovalNumber},Household,{note2.StartDate.ToShortDateString()},{note2.EndDate.ToShortDateString()},{note2.Recipient.Scheme.SchemeName},{note2.Recipient.Scheme.ApprovalNumber},Reuse network PWP,10.244,9.322,10.266,9.099,10.288,7.077,9.122,2.033,9.311,9.144,9.166,10.299,5.055,1.011,111.437,10.255,10.233,10.277,9.011,10.299,8.088,9.133,4.044,9.322,9.155,10.177,9.311,6.066,2.022,117.393\r\n";
        ...
        public class WhenIGetTheEvidenceNoteReportWithAatfParameterAndNetTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            ...
            private readonly It shouldHaveReturnedExpectedCsv = () =>
            {
                ...
                var expectedCsvData =
                    ...
                    $"E4,Approved,EA,{note4SubmittedDate},{note4.Aatf.Name},{note4.Aatf.ApprovalNumber},Household,{note4.StartDate.ToShortDateString()},{note4.EndDate.ToShortDateString()},{note4.Recipient.Name},,Reuse network PWP,10.244,9.322,10.266,9.099,10.288,7.077,9.122,2.033,9.311,9.144,9.166,10.299,5.055,1.011,111.437,10.255,10.233,10.277,9.011,10.299,8.088,9.133,4.044,9.322,9.155,10.177,9.311,6.066,2.022,117.393\r\n";
