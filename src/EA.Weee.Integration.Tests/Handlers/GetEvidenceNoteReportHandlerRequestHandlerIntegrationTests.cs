namespace EA.Weee.Integration.Tests.Handlers
{
    ...
    public class GetEvidenceNoteReportHandlerRequestHandlerIntegrationTests : IntegrationTestBase
    {
        ...
        public class WhenIGetTheEvidenceNoteReportWithAatfParameterAndOriginalTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            ...
            private readonly It shouldHaveReturnedExpectedCsv = () =>
            {
                ...
                var expectedCsvData =
                    ...
                    $"E3,Approved,EA,{note3SubmittedDate},{note3.Aatf.Name},{note3.Aatf.ApprovalNumber},Household,{note3.StartDate},{note3.EndDate},{note3.Recipient.Name},,Reuse network PWP,22.444,20.222,24.666,9.999,26.888,7.777,11.222,2.333,28.111,13.444,15.666,18.999,5.555,1.111,208.437,23.555,21.333,25.777,10.111,27.999,8.888,12.333,4.444,29.222,14.555,17.777,19.111,6.666,2.222,223.993\r\n";
        ...
        [Component]
        public class WhenIGetTheEvidenceNoteReportWithOrganisationParameterAndNetTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            private readonly Establish context = () =>
            {
                LocalOrganisationSetup();
                ...
                SchemeDbSetup.Init().WithOrganisation(recipientOrganisation1.Id).Create();
                var originatorOrganisation1 = OrganisationDbSetup.Init().Create();
                var aatf1 = AatfDbSetup.Init().WithOrganisation(originatorOrganisation1.Id).WithAppropriateAuthority(CompetentAuthority.England).Create();
                OrganisationUserDbSetup.Init().WithUserIdAndOrganisationId(UserId, originatorOrganisation1.Id).Create();
                ...
                //submitted note should not be included as not correct aatf
                var recipientOrganisation2 = OrganisationDbSetup.Init().Create();
                SchemeDbSetup.Init().WithOrganisation(recipientOrganisation2.Id).Create();
                var originatorOrganisation2 = OrganisationDbSetup.Init().Create();
                var aatf2 = AatfDbSetup.Init().WithOrganisation(originatorOrganisation2.Id).Create();
                ...
                // create submitted transfer from approved note so wont be included in total
                var newTransferNoteTonnage2 = new List<NoteTransferTonnage>()
                {
                    new NoteTransferTonnage(approvedWithTransfer.NoteTonnage.First(nt => nt.CategoryId.Equals(WeeeCategory.PhotovoltaicPanels)).Id,
                        0.1M, 0.2M),
                ...
                // create another approved transfer from approved note with null values
                var newTransferNoteTonnage3 = new List<NoteTransferTonnage>()
                {
                    new NoteTransferTonnage(approvedWithTransfer.NoteTonnage.First(nt => nt.CategoryId.Equals(WeeeCategory.PhotovoltaicPanels)).Id,
                        null, null),
            ...
            private readonly It shouldHaveReturnedExpectedCsv = () =>
            {
                ...
                var expectedCsvData =
                    ...
                    $"E3,Approved,EA,{note2SubmittedDate},{note2.Aatf.Name},{note2.Aatf.ApprovalNumber},Household,{note2.StartDate},{note2.EndDate},{note2.Recipient.Scheme.SchemeName},{note2.Recipient.Scheme.ApprovalNumber},Reuse network PWP,10.244,9.322,10.266,9.099,10.288,7.077,9.122,2.033,9.311,9.144,9.166,10.299,5.055,1.011,111.437,10.255,10.233,10.277,9.011,10.299,8.088,9.133,4.044,9.322,9.155,10.177,9.311,6.066,2.022,117.393\r\n";
        ...
        public class WhenIGetTheEvidenceNoteReportWithOriginatingOrganisationAndOriginalTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            ...
            private readonly It shouldHaveReturnedExpectedCsv = () =>
            {
                ...
                var expectedCsvData =
                    ...
                    $"E2,Submitted,EA,{note2SubmittedDate},{note2.Aatf.Name},{note2.Aatf.ApprovalNumber},Household,{note2.StartDate},{note2.EndDate},{note2.Recipient.Scheme.SchemeName},{note2.Recipient.Scheme.ApprovalNumber},Actual,22.444,20.222,24.666,9.999,26.888,7.777,11.222,2.333,28.111,13.444,15.666,18.999,5.555,1.111,208.437,23.555,21.333,25.777,10.111,27.999,8.888,12.333,4.444,29.222,14.555,17.777,19.111,6.666,2.222,223.993\r\n";
        ...
        public class WhenIGetTheEvidenceNoteReportWithOriginatingOrganisationAndNetTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            ...
            private readonly It shouldHaveReturnedExpectedCsv = () =>
            {
                ...
                var expectedCsvData =
                    ...
                    $"E3,Approved,EA,{note2SubmittedDate},{note2.Aatf.Name},{note2.Aatf.ApprovalNumber},Household,{note2.StartDate},{note2.EndDate},{note2.Recipient.Scheme.SchemeName},{note2.Recipient.Scheme.ApprovalNumber},Reuse network PWP,22.444,20.222,24.666,9.999,26.888,7.777,11.222,2.333,28.111,13.444,15.666,18.999,5.555,1.111,208.437,23.555,21.333,25.777,10.111,27.999,8.888,12.333,4.444,29.222,14.555,17.777,19.111,6.666,2.222,223.993\r\n" +

                    $"E4,Approved,SEPA,{note3SubmittedDate},{note3.Aatf.Name},{note3.Aatf.ApprovalNumber},Household,{note3.StartDate},{note3.EndDate},{note3.Recipient.Name},,Reuse network PWP,10.244,9.322,10.266,9.099,10.288,7.077,9.122,2.033,9.311,9.144,9.166,10.299,5.055,1.011,111.437,10.255,10.233,10.277,9.011,10.299,8.088,9.133,4.044,9.322,9.155,10.177,9.311,6.066,2.022,117.393\r\n";
        ...
        public class WhenIGetTheEvidenceNoteReportWithRecipientOrganisationAndNetTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            ...
            private readonly It shouldHaveReturnedExpectedCsv = () =>
            {
                ...
                var expectedCsvData =
                    ...
                    $"E4,Approved,SEPA,{note2SubmittedDate},{note2.Aatf.Name},{note2.Aatf.ApprovalNumber},Household,{note2.StartDate},{note2.EndDate},{note2.Recipient.Scheme.SchemeName},{note2.Recipient.Scheme.ApprovalNumber},Reuse network PWP,10.244,9.322,10.266,9.099,10.288,7.077,9.122,2.033,9.311,9.144,9.166,10.299,5.055,1.011,111.437,10.255,10.233,10.277,9.011,10.299,8.088,9.133,4.044,9.322,9.155,10.177,9.311,6.066,2.022,117.393\r\n";
        ...
        public class WhenIGetTheEvidenceNoteReportWithAatfParameterAndNetTonnages : GetEvidenceNoteReportHandlerRequestHandlerIntegrationTestBase
        {
            ...
            private readonly It shouldHaveReturnedExpectedCsv = () =>
            {
                ...
                var expectedCsvData =
                    ...
                    $"E4,Approved,EA,{note4SubmittedDate},{note4.Aatf.Name},{note4.Aatf.ApprovalNumber},Household,{note4.StartDate},{note4.EndDate},{note4.Recipient.Name},,Reuse network PWP,10.244,9.322,10.266,9.099,10.288,7.077,9.122,2.033,9.311,9.144,9.166,10.299,5.055,1.011,111.437,10.255,10.233,10.277,9.011,10.299,8.088,9.133,4.044,9.322,9.155,10.177,9.311,6.066,2.022,117.393\r\n";
