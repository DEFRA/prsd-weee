namespace EA.Weee.Core.AatfEvidence
{
    ...
    public class Protocol : Enumeration
    {
        ...
        public static readonly Protocol SiteProtocol = new Protocol(3, "Site protocol");
        public static readonly Protocol ReuseNetworkWeights = new Protocol(4, "Re-use network weights");
