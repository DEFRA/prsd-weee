namespace EA.Weee.Ibis.Tests.Unit
{
    ...
    public class CustomerFileTests
    {
        ...
        {
            // Arrange
            Address address = new Address("1 High Street", "Flat 123", "Business Park", "Newtown", "Nr Oldtown", "Testshire", "AA1 1AA", "England", true);
        ...
        [Fact]
        public void Write_WithOneCustomer_WithNonUkAddress_ConcatenatesPostCodeAndCountry()
        {
            // Arrange
            Address address = new Address("1 High Street", "Flat 123", "Business Park", "Newtown", "Nr Oldtown", "Testshire", "AA1 1AA", "Netherlands", false);
            Customer customer = new Customer("WEE0001", "Test customer", address);
            ...
            string expectedOutput =
                "\"H\",\"0000000\",\"WEE\",\"H\",\"C\",\"00000\",\"" + expectedDate + "\"" + Environment.NewLine +
                "\"D\",\"0000001\",\"WEE0001\",\"Test customer\",\"1 High Street\",\"Flat 123\",\"Business Park\",\"Newtown\",\"Nr Oldtown\",\"Testshire\",\"AA1 1AA  Netherlands\"" + Environment.NewLine +
                "\"T\",\"0000002\",\"0000003\"" + Environment.NewLine;
