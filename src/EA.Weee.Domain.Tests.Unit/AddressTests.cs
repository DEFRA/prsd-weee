namespace EA.Weee.Domain.Tests.Unit
{
    ...
    public class AddressTests
    {
        ...
        [Theory]
        [InlineData(null, "NR", "R", "NR", "NR", "R", "R", "R", "R", "R")]
        [InlineData("R", "NR", null, "NR", "NR", "R", "R", "R", "R", "R")]
        [InlineData("R", "NR", "R", "NR", "NR", null, "R", "R", "R", "R")]
        [InlineData("", "NR", "R", "NR", "NR", "R", "R", "R", "R", "R")]
        [InlineData("R", "NR", "", "NR", "NR", "R", "R", "R", "R", "R")]
        [InlineData("R", "NR", "R", "NR", "NR", "", "R", "R", "R", "R")]
        public void CreateAddress_RequiredPropertyIsNullOrEmpty_ShouldThrowArgumentException(string address1, string address2,
            string townOrCity, string countyOrRegion, string postcode, string country, string telephone, string email, string webAddress, string fax)
        {
