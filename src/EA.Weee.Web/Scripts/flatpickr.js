/* flatpickr v4.6.1,, @license MIT */ ! function (e, t) {
    ...
    function y(f, g) {
        ...
        function U() {
            ...
            h.config.showMonths > 1 ? e = d("span", "cur-month") :
            ...
            var label = d("label", "govuk-visually-hidden");
            label.innerText = "current month";
            label.setAttribute("for", "current_month");
            h.monthsDropdownContainer.id = "current_month";
            return o.appendChild(label), o.appendChild(e), o.appendChild(a), n.appendChild(o), t.appendChild(n), {
                container: t,
                yearElement: i,
                monthElement: e
            }
