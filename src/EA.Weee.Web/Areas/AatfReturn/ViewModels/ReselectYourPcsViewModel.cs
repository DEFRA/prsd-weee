namespace EA.Weee.Web.Areas.AatfReturn.ViewModels
{
    ...
    public class ReselectYourPcsViewModel
    {
        public ReselectYourPcsViewModel(List<SchemeData> schemeList, List<Guid> selectedSchemes)
        {
        ...
        public ReselectYourPcsViewModel()
        {
        }
