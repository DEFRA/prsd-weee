namespace EA.Weee.Web.Areas.Aatf
{
    ...
    public class AatfAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapLowercaseDashedRoute(
                name: AatfEvidenceRedirect.ViewVoidedEvidenceRouteName,
                url: "Aatf/{organisationId}/manage-evidence-notes/{aatfId}/view-voided-evidence-note/{evidenceNoteId}",
                defaults: new { action = "ViewDraftEvidenceNote", controller = "ManageEvidenceNotes", noteStatus = NoteStatus.Void },
                namespaces: new[] { typeof(ManageEvidenceNotesController).Namespace });
            ...
            context.MapLowercaseDashedRoute(
                name: AatfEvidenceRedirect.ViewCancelEvidenceRouteName,
                url: "Aatf/{organisationId}/manage-evidence-notes/{aatfId}/view-cancel-evidence-note/{evidenceNoteId}",
                defaults: new { action = "ViewDraftEvidenceNote", controller = "ManageEvidenceNotes", noteStatus = NoteStatus.Cancelled },
                namespaces: new[] { typeof(ManageEvidenceNotesController).Namespace });
