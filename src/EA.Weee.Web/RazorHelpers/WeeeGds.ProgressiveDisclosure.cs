    ...
    public class ProgressiveDisclosure<TModel> : IDisposable
    {
        ...
        public ProgressiveDisclosure(WeeeGds<TModel> gdsHelper, string linkText)
        {
            ...
            var html = string.Format(
                @"<details class=""govuk-details"" data-module=""govuk-details"" aria-live=""polite"" role=""group""><summary class=""govuk-details__summary""><span class=""govuk-details__summary-text"">{1}<span class=""hidden-for-screen-reader"">This is an expandable link that will reveal more content upon activation</span></span></summary><div class=""govuk-details__text"">",
