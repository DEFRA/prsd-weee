        ...
        public MvcHtmlString CreateProgressiveDisclosure(string linkText, string hiddenContent, string eventCategory, string eventAction, string eventLabel, object htmlAttributes = null)
        {
            if (!string.IsNullOrWhiteSpace(eventCategory))
            {
                return new MvcHtmlString(
                    $@"<details class=""govuk-details"" data-module=""govuk-details"" aria-live=""polite"" role=""group"" onclick=""{EventTrackingFunction(eventCategory, eventAction, eventLabel)}""><summary class=""govuk-details__summary""><span class=""govuk-details__summary-text"">{linkText}<span class=""govuk-visually-hidden"">This is an expandable link that will reveal more content upon activation</span></span></summary><div class=""govuk-details__text"" id=""details-content"" aria-hidden=""true""><div class=""govuk-body govuk-!-font-size-16"">{hiddenContent}</div></div></details>");
            }

            return new MvcHtmlString(
                $@"<details class=""govuk-details"" data-module=""govuk-details"" aria-live=""polite"" role=""group""><summary class=""govuk-details__summary""><span class=""govuk-details__summary-text"">{linkText}<span class=""govuk-visually-hidden"">This is an expandable link that will reveal more content upon activation</span></span></summary><div class=""govuk-details__text"" id=""details-content"" aria-hidden=""true""><div class=""govuk-body govuk-!-font-size-16"">{hiddenContent}</div></div></details>");
        }
